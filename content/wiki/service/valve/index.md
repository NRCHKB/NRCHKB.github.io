...
lastmod: 2021-10-23T13:04:25.208Z
draft: false
images: []
menu:
  docs:
...
2. Configure the `Read PLC` and `Write PLC` nodes with address of the sprinkler on your PLC. Here the address is H2. [Help](https://github.com/Steve-Mcl/node-red-contrib-omron-fins)
