...
**Note :** For the "rtsp url" in `Source`, visit [this site](https://www.getscw.com/decoding/rtsp) for example. For more info visit about [Camera]({{< ref "/wiki/service/camera-control.md#examples" >}} "Camera Control")
