...
**Note :** For the "rtsp url" in `Source`, visit [this site](https://www.getscw.com/decoding/rtsp) for example. For more info visit [Camera Controle](https://nrchkb.github.io/wiki/service/camera-control/)
