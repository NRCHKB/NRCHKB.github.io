...
lastmod: 2021-08-11T19:03:19.417Z
draft: false
images: []
menu:
  docs:
...
- nrchkb complaining about validValues [#52](https://github.com/NRCHKB/node-red-contrib-homekit-bridged/issues/52)
...
- onChange fired when value not changed [#390](https://github.com/NRCHKB/node-red-contrib-homekit-bridged/issues/390) - thanks for reporting [@Delphius7](https://github.com/Delphius7)
...
- Linked service throws error during setup if parent waits for the setup message (thanks [@AlexOwl](https://github.com/AlexOwl))
