...
![Service Hierarchy Node-Red](content/wiki/nodes/service-node/service-hierarchy-node-red.png)

In Home.app room view it will be displayed as one accessory.

![Service Hierarchy Home.app Overview](content/wiki/nodes/service-node/service-hierarchy-home.app-overview.png)

In Home.app in accessory detail view you will also notice battery percentage.

![Service Hierarchy Home.app Details](content/wiki/nodes/service-node/service-hierarchy-home.app-details.png)
...
- You can also create a new one by clicking the same button when *Add new homekit-standalone...* is selected. ![Adding new HomeKit Standalone Accessory](content/wiki/nodes/service-node/add-new-homekit-standalone-accessory.png)
...
- You can also create a new one by clicking the same button when *Add new homekit-bridge...* is selected. ![Adding new HomeKit Bridge](content/wiki/nodes/service-node/add-new-homekit-bridge.png)
